		...
		<div class="right-col-wrap col-12 col-lg-3 d-flex flex-column border-start">
			...
			<div class="right-col-header">
				<div class="border-bottom border-1 p-3 bg-body">
					<h5 class="h6 mb-1">Footer Elements</h5>
					<p class="m-0 v-small text-muted">Drag elements and place them where you want in the footer</p>
				</div>
			...
			<div class="right-col-inner overflow-auto flex-fill d-flex flex-column">
				...
				<div class="col p-3">
					...
					<div>
						<div class="btn bg-body text-start p-2 pe-3 border-dash-always hover-shadow d-flex align-items-center"><i class="bi bi-grip-vertical me-3 bg-light rounded-1 fs-5"></i>
							<span class="fs-4 me-2 ki-duotone ki-password-check"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></span>Divider
						</div>
					</div>
						<div>
							<div class="btn bg-body text-start p-2 pe-3 border-dash-always hover-shadow d-flex align-items-center"><i class="bi bi-grip-vertical me-3 bg-light rounded-1 fs-5"></i>
								<span class="fs-4 me-2 ki-duotone ki-sms"><span class="path1"></span><span class="path2"></span><span class="path3"></span></span>Contact
							</div>
						</div>
						<div>
							<div class="btn bg-body text-start p-2 pe-3 border-dash-always hover-shadow d-flex align-items-center"><i class="bi bi-grip-vertical me-3 bg-light rounded-1 fs-5"></i>
								<span class="fs-4 me-2 ki-duotone ki-directbox-default"><span class="path1"></span><span class="path2"></span><span class="path3"></span></span>Subscription
							</div>
						</div>
			...
			<div class="rz-meta-box mt-auto shadow-sm border-top p-3 bg-body sticky-bottom">
				<div class="row row-cols-md-2 g-2 flex-wrap">
					<div class="mw-max-content">
						<a href="" class="btn btn-sm w-100 btn-primary d-flex align-items-center justify-content-center">Save footer</a>
					</div>
