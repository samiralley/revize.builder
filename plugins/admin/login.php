...
<body id="sign-in-form" class="vh-100 px-4 px-lg-0">
	...
	<div class="vh-100 position-absolute top-0 end-0 d-none d-xl-block overflow-hidden" style="width:25%;background:url(_assets_/images/login-bg.jpg) center center/ cover no-repeat">
		...
		<div class="position-absolute top-0 end-0 me-3 mt-3">
			<span class="text-white pt-2 d-inline-flex position-relative" style="top:6px">Designed by</span>
	...
	<main class="form-signin d-flex m-auto vh-100">
		<div class="col col-sm-8 col-md-5 col-xl-3 m-auto">
			<form>
				...
				<p class="mt-5 mb-3 text-muted small">© <?php echo date("Y"); ?> revize. By continuing, you confirm that you agree to our <a href="https://www.revize.com/terms.php">Privacy Policy</a> and <a href="https://www.revize.com/terms.php">Terms of Use</a></p>
			</form>
		</div>
	</main>
