<div id="google-translate-wrap" class="header-element header-translate-wrap dropdown relative d-none d-lg-flex align-items-stretch gap-0">
	<div class="vr vr-s"></div>
	<button class="translate-button btn btn-link relative px-3 dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
