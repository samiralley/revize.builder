<!-- #done -->
<div class="offcanvas offcanvas-bottom offcanvas-blog-item mx-auto" tabindex="-1" id="blogDetails" aria-labelledby="blogDetailsLabel" style="--bs-offcanvas-height:98vh;width:98%;">
	...
	<div class="offcanvas-body pt-0">
 		<div class="container p-0">
			...
			<div class="sticky-top">
				<div class="d-md-flex small bg-white flex-wrap align-items-start py-3">
					<div class="d-flex me-3 align-items-start">
						<img loading="lazy" src="_assets_/images/user.png" alt="author name" class="w-h-48 flex-shrink-0 me-3 border rounded-circle">
						<div class="d-flex post-info-wrap flex-column">
							<p class="post-by m-0">
					...
					<div class="post-btns-wrap ms-auto mt-3 my-md-0">
						<div class="post-fav d-flex align-items-center gap-2">
							<span class="btn px-3 py-1 py-md-2 btn-outline-light d-flex gap-2 align-items-center rounded-pill" id="saveBlogItemBtn">
		...
		<div class="p-2 px-md-5">
			<p class="blog-subtitle text-muted text-uppercase small">Sit Ornare Ultricies</p>
			<h3 class="mb-3 h1">Title of blog item here Praesent commodo cursus magna</h3>
			...
			<nav aria-label="breadcrumb" style="--bs-breadcrumb-divider:'›';" class="small mt-4 text-nowrap">
				<ol class="breadcrumb align-items-center flex-nowrap">
					...
					<li class="breadcrumb-item active text-truncate" aria-current="page">Title of blog item here Praesent commodo cursus magna</li>
				</ol>
			</nav>			
			<div id="post-details">
			<p class="lead">
...
<div class="toast align-items-center text-bg-success border-0 position-fixed position-absolute bottom-0 start-50 translate-middle mb-4" id="savedBlogItem" role="alert" aria-live="assertive" aria-atomic="true">
	<div class="d-flex">
		<div class="toast-body">
			Added to your favorites!  
			<a href="loved.php" class="text-light">See all here</a>
		</div>
...
// const toastTrigger = document.getElementById('saveBlogItemBtn')
// const toastSaved = document.getElementById('savedBlogItem')
// 
// if (toastTrigger) {
