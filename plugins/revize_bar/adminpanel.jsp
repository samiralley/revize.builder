...
function RZadminwin(msg,action)
{
	...
	if (msg)
	{
		...
		RZsetInnerHTML(RZadminwin.textId,'<div class="revize-response">'+msg+'</div>');
	}
...
#RZadminwin_login:hover{
	background:#4c00ca !important
}
  ...
  <form id="RZadminwin_form" action="#">
    <div id="RZadminwin_templates">
      <button type="button" id="permissionsBtn" onClick="permissionsCall();" >
		  ...
		  <path d="M15.602 5.25537C16.4301 5.6627 17 6.5148 17 7.5C17 8.4852 16.4301 9.3373 15.602 9.74463C15.2911 10.5894 14.8098 11.3518 14.1998 11.9901C14.299 11.9967 14.3991 12 14.5 12C16.9852 12 19 9.98528 19 7.5C19 5.01472 16.9852 3 14.5 3C14.3991 3 14.299 3.00332 14.1998 3.00985C14.8098 3.64818 15.2911 4.41058 15.602 5.25537Z" fill="#000000"/>
		  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5 10C10.8807 10 12 8.88071 12 7.5C12 6.11929 10.8807 5 9.5 5C8.11929 5 7 6.11929 7 7.5C7 8.88071 8.11929 10 9.5 10ZM9.5 12C11.9853 12 14 9.98528 14 7.5C14 5.01472 11.9853 3 9.5 3C7.01472 3 5 5.01472 5 7.5C5 9.98528 7.01472 12 9.5 12Z" fill="#000000"/>
		  <path d="M5 16H14C15.1046 16 16 16.8954 16 18V21H18V18C18 15.7909 16.2091 14 14 14H5C2.79086 14 1 15.7909 1 18V21H3V18C3 16.8954 3.89543 16 5 16Z" fill="#000000"/>
		  <path d="M21 20.9999L23 20.9999L23 18.9999C23 16.405 21.0234 14.2718 18.4937 14.0239C19.142 14.7561 19.6141 15.648 19.8436 16.633C20.5474 17.182 21 18.0381 21 18.9999V20.9999Z" fill="#000000"/>
		  </svg>		  
		  <span class="small">Permissions <em>Edit user permissions for editing pages throughout the website</em></span>
	  </button>

	<% if(revize_username.equals("root") || revize_username.indexOf("revize.com") != -1) { %>
	  <a href="./../../admincenter/rptDeleteFiles.jsp" target="_blank" id="fileDeleteBtn" class="button">
			<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path fill-rule="evenodd" clip-rule="evenodd" d="M15.7207 2H8.27919L7.27919 5H2V7H4V22H20V7H22V5H16.7207L15.7207 2ZM14.6125 5L14.2792 4H9.72071L9.38738 5H14.6125ZM6 7H18V20H6V7Z" fill="red"/>
			<path fill-rule="evenodd" clip-rule="evenodd" d="M9 18V9H11V18H9Z" fill="red"/>
			<path fill-rule="evenodd" clip-rule="evenodd" d="M13 18V9H15V18H13Z" fill="red"/>
			</svg>
			<span class="small">File Cleanup<em>Delete obsolete revize managed files</em></span>
		</a>
	<% } %>  		 
	  ...
	  <button type="button" id="fileMgrBtn" onClick="fileMgrCall();" >
		  ...
		  <span class="small">File Manager <em>Browse files within your website or upload new ones</em></span>
