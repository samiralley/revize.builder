...
<div class="news-intro">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 py-5 overflow-hidden">
				<h1 data-aos="fade-up-right"
				data-aos-duration="600"><span class="mega-font">Latest City News</span></h1>
			</div><!-- /.col-12 -->
		</div>
	</div>
</div>

<div class="news-hero mb-5 bg-primary-subtle py-5">
	<div class="container">
		<div class="row">
			...
			<div class="col">
				<div data-aos="fade-up"
					...
					<div class="rz-card rz-news-card gap-5 py-5"
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				data-aos-duration="600"><span class="mega-font">Latest News from site name</span></h2>
			</div>

			<div class="col-lg-12 py-5">

				<div class="rz-element-wrapper rz-news-card-wrapper has-edit-buttons yes-has-edit-buttons">
						...
						<div data-aos="fade-up"
							...
							<div class="rz-card rz-news-card"
								...
								<div class="rz-card-body">
									...
									<p class="rz-card-text">This is the default layout for all cards Donec id elit non mi porta gravida at eget metus. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.
									</p>
									<div class="rz-card-actions">
										<a href="#"
											class="btn btn-primary rz-card-btn"
						...
						<div data-aos="fade-up"
							...
							<div class="rz-card rz-news-card"
								...
								<div class="rz-card-body">
									<p class="rz-card-date"><small>Published: Jan 9 2029</small></p>
									<h3 class="rz-card-title">Stacked Card (default)</h3>
									<p class="rz-card-text">This is the default layout for all cards Donec id eget lacinia odio sem nec elit.
									</p>
									<div class="rz-card-actions">
										<a href="#"
											class="btn btn-primary rz-card-btn"
						...
						<div data-aos="fade-up"
							...
							<div class="rz-card rz-news-card"
								...
								<div class="rz-card-body">
									<p class="rz-card-date"><small>Published: Jan 9 2029</small></p>
									<h3 class="rz-card-title">Stacked Card (default)</h3>
									<p class="rz-card-text">This is the default layout for all cards Donec id igula, eget lacinia odio sem nec elit.
									</p>
									<div class="rz-card-actions">
										<a href="#"
											class="btn btn-primary rz-card-btn"
						...
						<div data-aos="fade-up"
							...
							<div class="rz-card rz-news-card"
								...
								<div class="rz-card-body">
									<p class="rz-card-date"><small>Published: Jan 9 2029</small></p>
									<h3 class="rz-card-title">Stacked Card (default)</h3>
									<p class="rz-card-text">This is the default layout for all cards Donec id elit non mi porta gravida at eget metus. Duis mollis, est non commodo luctus, nisi erat porttitor lig
									</p>
									<div class="rz-card-actions">
										<a href="#"
											class="btn btn-primary rz-card-btn"
